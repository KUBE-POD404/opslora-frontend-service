...
includes(detail, "Download PDF")
includes(detail, "downloadApiBlob(`/invoices/${invoice.id}/download`")
includes(detail, "downloadInvoiceHtml(invoice, payments)", "HTML fallback")
